...
test('attachment fallback must be string', t => {
    try{
        ...
        t.is(err, 'Attachment fallback has value of 3 but is expected to be a string')
    }
})
...
test('attachment pretext must be string', t => {
    try{
        ...
        t.is(err, 'Attachment pretext has value of 3 but is expected to be a string')
    }
})
...
test('attachment author_name must be string', t => {
    try{
        ...
        t.is(err, 'Attachment author_name has value of 3 but is expected to be a string')
    }
})
...
test('attachment author_icon must be string', t => {
    try{
        ...
        t.is(err, 'Attachment author_icon has value of 3 but is expected to be a string')
    }
})
...
test('attachment author_link must be string', t => {
    try{
        ...
        t.is(err, 'Attachment author_link has value of 3 but is expected to be a string')
    }
})
...
test('attachment title_link must be string', t => {
    try{
        ...
        t.is(err, 'Attachment title_link has value of 3 but is expected to be a string')
    }
})
...
test('attachment image_url must be string', t => {
    try{
        ...
        t.is(err, 'Attachment image_url has value of 3 but is expected to be a string')
    }
})
...
test('attachment thumb_url must be string', t => {
    try{
        ...
        t.is(err, 'Attachment thumb_url has value of 3 but is expected to be a string')
    }
})
